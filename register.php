          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-4">
                <h3 class="text-secondary text-center mb-4">User Signup</h3>
                <form class="pt-1" action="/signup.php" method="post">
                  ...
                  <div class="form-group">
                    <input type="text" name="address" required class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Address">
                  </div>
                  <div class="mt-3 text-center">
                    <button class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Register</button>
                  </div>
                  <br>
                  <p class="text-center text-muted">Do you have an account? <a href="/">Login</a></p>
                </form>
              </div>
            </div>
          </div>
